...
export interface DefectClassification {
  type: 'ORPHAN_TASK' | 'CORRUPT_BANK_CONFIG' | 'EXPIRED_SESSION_LOCKOUT' | 'SCHEMA_MISMATCH' | 'UNINDEXED_TENANT' | 'UNKNOWN';
...
export class DiagnosticsEngine {
  static classify(errorText: string): DefectClassification {
